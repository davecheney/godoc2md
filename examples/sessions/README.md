...
## <a name="NewCookie">func</a> [NewCookie](/src/target/sessions.go?s=5493:5558#L197)
``` go
...
## <a name="Save">func</a> [Save](/src/target/sessions.go?s=5231:5286#L190)
``` go
...
## <a name="MultiError">type</a> [MultiError](/src/target/sessions.go?s=6165:6188#L222)
``` go
...
### <a name="MultiError.Error">func</a> (MultiError) [Error](/src/target/sessions.go?s=6190:6224#L224)
``` go
...
## <a name="Options">type</a> [Options](/src/target/sessions.go?s=516:843#L24)
``` go
type Options struct {
    Path   string
    Domain string
...
## <a name="Registry">type</a> [Registry](/src/target/sessions.go?s=3801:3882#L141)
``` go
...
### <a name="GetRegistry">func</a> [GetRegistry](/src/target/sessions.go?s=3456:3499#L127)
``` go
...
### <a name="Registry.Get">func</a> (\*Registry) [Get](/src/target/sessions.go?s=4042:4120#L149)
``` go
...
### <a name="Registry.Save">func</a> (\*Registry) [Save](/src/target/sessions.go?s=4538:4590#L165)
``` go
...
## <a name="Session">type</a> [Session](/src/target/sessions.go?s=1256:1530#L49)
``` go
type Session struct {
...
### <a name="NewSession">func</a> [NewSession](/src/target/sessions.go?s=1002:1052#L39)
``` go
...
### <a name="Session.AddFlash">func</a> (\*Session) [AddFlash](/src/target/sessions.go?s=2211:2272#L83)
``` go
...
### <a name="Session.Flashes">func</a> (\*Session) [Flashes](/src/target/sessions.go?s=1734:1789#L65)
``` go
...
### <a name="Session.Name">func</a> (\*Session) [Name](/src/target/sessions.go?s=2837:2868#L103)
``` go
...
### <a name="Session.Save">func</a> (\*Session) [Save](/src/target/sessions.go?s=2678:2746#L98)
``` go
...
### <a name="Session.Store">func</a> (\*Session) [Store](/src/target/sessions.go?s=2954:2985#L108)
``` go
